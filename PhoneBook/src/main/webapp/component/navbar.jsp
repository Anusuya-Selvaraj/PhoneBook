...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="addcontact.jsp"><i class="fa-solid fa-square-plus"></i> Add Contacts</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link active" href="viewcontact.jsp"><i class="fa-solid fa-eye"></i> View Contacts</a>
      </li>
    </ul>
